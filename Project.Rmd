...
В построенной модели, во первых, мы видим интерсепт чуть меньше нуля (конечно, хотелось бы увидеть здесь ноль, но это тоже не так уж и плохо). Во-вторых, можем сделать вывод, что для линейного приближения, вес раковины вносит наибольший вклад в общий вес моллюска, но в целом незначительно больше. При этом, наша модель объясняет 99% дисперсии, что говорит о том, что такая модель имеет довольно хорошую предсказательную силу.